...
/**
 * Unit tests for {@link DeploymentSubmissionAdapter}.
 *
 ...
 */
class DeploymentSubmissionAdapterTest {

    private DeploymentSubmissionAdapter adapter;

    @BeforeEach
    void setUp() {
        adapter = new DeploymentSubmissionAdapter();
    }

    // ---- operationType ----

    @Test
    void toReleaseCommandRequest_alwaysSetsOperationTypeDeploy() {
    ...
    void toReleaseCommandRequest_mapsAllFields() {
        DeploymentSubmissionRequest req = fullRequest();
    ...
    @Test
    void collectPrevalidationWarnings_noContext_returnsThreeWarnings() {
        DeploymentSubmissionRequest req = new DeploymentSubmissionRequest();
        req.setCustomerId("c");
        req.setSfdcToolId("t");
        req.setTaskId("step-001");
    ...
    private DeploymentSubmissionRequest fullRequest() {
        DeploymentSubmissionRequest req = new DeploymentSubmissionRequest();
